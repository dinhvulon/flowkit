...
# Ensure flowkit is in python path for watermark removal
...
project_payload = {
    ...
    "description": "POV Time Travel Vlog: Mia journeys back to ancient Babylon at its peak in 570 BC, exploring the Euphrates markets and discovering the engineering secrets of the Hanging Gardens.",
...
pid = project_res["id"]
print(f"Project created successfully! ID: {pid}", flush=True)

# Re-link Mia face reference image
...
conn.commit()
conn.close()
print("Mia character reference image linked!", flush=True)

# ==============================================================================
# 3. CREATE VIDEO & SWITCH ACTIVE
# ==============================================================================
...
# ==============================================================================
# 4. CREATE 23 SCENES WITH CLEAN PROMPTS (NO STICKS IN SELFIE)
# ==============================================================================
scenes_data = [
    # Act 1: Hook (0-5%)
    {
...
# ==============================================================================
# 6. MONITOR BATCH UNTIL ALL 23 SCENE IMAGES COMPLETED
# ==============================================================================
print(">>> 6. Monitoring Batch Image Generation...", flush=True)
...
for poll in range(1, 150):
    ...
    try:
        ...
        if is_done or completed == total:
            print("All scene images completed generation!", flush=True)
            break
    except Exception as e:
        print(f"  [Poll {poll:02d}] Error polling batch status: {e}", flush=True)

# ==============================================================================
# 7. DOWNLOAD IMAGES, REMOVE WATERMARK & UPLOAD CLEAN FRAMES
# ==============================================================================
print(">>> 7. Downloading images & Removing Watermarks...", flush=True)

# Fetch project output dir
